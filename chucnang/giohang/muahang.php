...
<?php
    ...
    // Phải chỉnh sửa lại
    $mailer->Username = "dreamlyrics2210@gmail.com"; // GMAIL username
    $mailer->Password = "Anhiuem2210"; // GMAIL password
    $mailer->AddAddress($mail, $ten); //email người nhận
    $mailer->AddCC("dreamlyrics2210@gmail.com", "Admin Son Shop"); // gửi thêm một email cho Admin
    // Chuẩn bị gửi thư nào
    $mailer->FromName = 'Son Shop'; // tên người gửi
    $mailer->From = 'dreamlyrics2210@gmail.com'; // mail người gửi
    $mailer->Subject = 'Hóa đơn xác nhận mua hàng từ Son Shop';
